...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xs-offset-0 col-sm-offset-0" >
        <div class="panel panel-info">
            ...
            <div class="panel-heading">
                <h3 class="panel-title" style="text-align:center" >Add New E-Information</h3>
            </div>

            <div class="panel-body">
                <form action="/Dashboard/einfo" method="POST">
                    {{ csrf_field() }}
            ...
            <tbody class="panel-body">
                    ...
                    <td>{{ $einfo->title }}</td>
                        <td style="width:150px;">
                            <a class='btn btn-info btn-xs' href="/Dashboard/einfo/{{$einfo->id}}/edit"><span class="glyphicon glyphicon-edit"></span> Edit</a>
                            <form action="/Dashboard/einfo/{{$einfo->id}}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
